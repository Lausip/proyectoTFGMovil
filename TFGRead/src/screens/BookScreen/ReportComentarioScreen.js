...
import { enviarReporteComentario } from "../../hooks/FirebaseReportes"
...
function ReportarComentarioScreen({ route }) {
    ...
    const { bookId,capituloId,comentarioId,capituloNumero } = route.params;

    useEffect(() => {
        hacerCosas();
        BackHandler.addEventListener('hardwareBackPress', handleComentario);

        return () =>
          BackHandler.removeEventListener('hardwareBackPress', handleComentario);
    ...
    const enviarReporte = async () => {
        ...
        await enviarReporteComentario(email, "Comentario", "Contenido inapropiado", selectedOptionMini, motivo, bookId,comentarioId,capituloId);
    ...
    return (
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={{
                ...
                <TouchableOpacity testID='buttonGoHome' onPress={() => handleComentario()}>
...
export default ReportarComentarioScreen