...
describe('ReportAutorScreen test', () => {
    ...
    it('Should render ReportAutorScreen', async () => {
        React.useState = jest.fn()
            .mockReturnValue([true, {}])
    
        await firebase.initializeTestApp({ projectId: "tfgbook-f69af" }).firestore();
        const component = render(<ReportAutorScreen route={{ params: { autorElegido: "admin@gmail.com" } }} />)
